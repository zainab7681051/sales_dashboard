...
export const chartsData = [
  {
    ...
    type: 'line',
    series: [vistor_insights[0], vistor_insights[1], vistor_insights[2]],
    options: {
      chart: {
        zoom: { enabled: false },
        toolbar: { show: false },
  ...
  },
  {
    ...
    title: 'total revenue',
    type: 'bar',
    series: [total_revenue[0], total_revenue[1]],
    options: {
      chart: {
        zoom: { enabled: false },
        toolbar: { show: false },
  ...
  },
  {
    ...
    type: 'area',
    series: [customer_satisfaction[0], customer_satisfaction[1]],
    options: {
      chart: {
        zoom: { enabled: false },
        toolbar: { show: false },
  ...
  },
  {
    ...
    type: 'bar',
    series: [target_vs_reality[0], target_vs_reality[1]],
    options: {
      chart: {
        zoom: { enabled: false },
        toolbar: { show: false },
  ...
  },
  {
    ...
    type: 'bar',
    series: [volume_services_level[0], volume_services_level[1]],
    options: {
      chart: {
        zoom: { enabled: false },
        toolbar: { show: false },
